...
public class SpectrumItems {
	...
	public static ConditionalFoodComponent teaSconeBonus(FoodComponent foodComponent) {
		return new ConditionalFoodComponent(ItemPredicate.Builder.create().items(SpectrumItems.SCONE).build(), true, foodComponent);
	}
	...
	// Special tools
	// TODO: set attribute modifiers similarly to how vanilla does it
	public static final Item DREAMFLAYER = new DreamflayerItem(SpectrumToolMaterial.DREAMFLAYER, 3, -1.8F, IS.of(1, Rarity.UNCOMMON));
	public static final Item NIGHTFALLS_BLADE = new NightfallsBladeItem(SpectrumToolMaterial.NIGHTFALL, 0, -3.4F, IS.of(1, Rarity.UNCOMMON).attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.DIAMOND, 3, -2.4F)))
