...
public class BlockPosEventQueue extends EventQueue<BlockPosEventQueue.EventEntry> {
	...
	public void acceptEvent(World world, GameEvent.Message event, Vec3d sourcePos) {
		if (world instanceof ServerWorld) {
			...
			TypedTransmissionPayload.playTransmissionParticle((ServerWorld) world, new TypedTransmission(emitterPos, this.positionSource, delay, TypedTransmission.Variant.BLOCK_POS));
		}
	}
